...
import com.xiaoya.domain.quartz.JobDetails;
import com.xiaoya.domain.quartz.QuartzManager;
import com.xiaoya.domain.quartz.vo.QuartzQueryAllVo;
...
public class QuartzManagerController {
    ...
    @PostMapping("/test")
    public String test(@RequestBody QuartzQueryAllVo req) {
        return "hello";
    }
    ...
    public RespBean getAllByPaginationAndKeyWord(@RequestBody QuartzQueryAllVo quartzQueryAllVo) {
        System.out.println(quartzQueryAllVo);
